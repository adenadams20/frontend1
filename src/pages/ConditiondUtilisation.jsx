    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-300">
      ...
      >
        ...
        <ul className="space-y-4">
          ...
          <li><a href="#accueil" className="hover:underline">Accueil du Centre</a></li>
          <li><a href="#sujets" className="hover:underline">Sujets liés à la confidentialité</a></li>
          <li><a href="#ressources" className="hover:underline">Ressources supplémentaires</a></li>
        </ul>
      </aside>
      ...
      <main
        className="
          flex-1 p-8 overflow-y-auto space-y-8 
          md:ml-72 
        "
      >
        <section id="politique" className="bg-white p-6 rounded-xl shadow">
          ...
          <p>
            ...
            sécurisés, personnalisés et conformes aux réglementations financières.
          </p>
        </section>
        ...
        <section id="accueil" className="bg-white p-6 rounded-xl shadow">
          ...
          <p>
            ...
            collectons, comment nous les utilisons et les partageons.
          </p>
        </section>
        ...
        <section id="ressources" className="bg-white p-6 rounded-xl shadow">
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Gestion et sécurisation du compte</li>
            <li>Authentification</li>
            <li>Exécution de transactions</li>
