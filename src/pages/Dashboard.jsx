...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen p-6 lg:p-12 pr-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow">
          ...
          <LineChart width={380} height={260} data={lineData}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-10">
        ...
        <div className="bg-white p-10 rounded-2xl shadow">
          ...
          <div className="space-y-6">
            <TransactionItem icon="🎬" bg="bg-purple-100" color="text-purple-600" title="Netflix" subtitle="Abonnement" amount="-11 807 FCFA" amountColor="text-red-500" date="2025-01-20" />
            <TransactionItem icon="💰" bg="bg-yellow-100" color="text-yellow-500" title="Salaire" subtitle="Revenu" amount="+1 639 893 FCFA" amountColor="text-green-600" date="2025-01-21" />
            <TransactionItem icon="🛒" bg="bg-blue-100" color="text-blue-500" title="Carrefour" subtitle="Alimentation" amount="-7 871 FCFA" amountColor="text-red-500" date="2025-01-02" />
            <TransactionItem icon="⛽" bg="bg-red-100" color="text-red-500" title="Essence" subtitle="Transport" amount="-29 518 FCFA" amountColor="text-red-500" date="2025-01-05" />
          </div>
        </div>
